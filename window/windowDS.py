...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.menuGNSS_2.addSeparator()
        self.menuGNSS_2.addAction(self.actionsd)
        self.menu.addAction(self.munuItem_stablePointGround)
        self.menu.addSeparator()
        self.menu.addAction(self.actions)
        self.menu_E.addAction(self.munuItem_railwayCurve)
        self.menu_E.addSeparator()
        self.menu_E.addAction(self.munuItem_CPIII)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.menuGNSS_2.setTitle(_translate("mainWindow", "GNSS导航定位(&G)"))
        self.menu.setTitle(_translate("mainWindow", "大地测量与形变监测(&D)"))
        self.menu_E.setTitle(_translate("mainWindow", "工程测量(&E)"))
        ...
        self.actions.setText(_translate("mainWindow", "三维重建与时序形变监测(&W)"))
